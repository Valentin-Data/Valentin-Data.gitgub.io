...
<div style="text-align: center; max-width: 600px; margin: 50px auto; padding: 40px; background: rgba(11, 14, 20, 0.85); border: 1px solid #00f2ff; border-radius: 15px;">
  ...
  <h2>Contacto</h2>
  <p>¡Me encantaría conectar contigo! Puedes encontrarme a través de los siguientes medios:</p>
