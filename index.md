...
<section id="acerca" style="padding: 80px 20px; text-align: center;">
  <div style="max-width: 800px; margin: auto; background: rgba(11,14,20,0.8); padding: 30px; border-radius: 15px; border: 1px solid #00f2ff;">
    <h2>Acerca de mí</h2>
...
<section id="proyectos" style="padding: 80px 20px; text-align: center;">
  <div style="max-width: 800px; margin: auto; background: rgba(11,14,20,0.8); padding: 30px; border-radius: 15px; border: 1px solid #00f2ff;">
    <h2>Proyectos</h2>
    <p>Proyecto 1: Transformación de un dataset con inconsistencias en información confiable y estructurada mediante              Python (pandas, matplotlib), permitiendo un análisis de stock preciso.
       Proyecto 2: [Próximamente] - Estoy trabajando en nuevas implementaciones y análisis de datos.</p>
  </div>
</section>

<section id="contacto" style="padding: 80px 20px; text-align: center;">
  <div style="max-width: 800px; margin: auto; background: rgba(11,14,20,0.8); padding: 30px; border-radius: 15px; border: 1px solid #00f2ff;">
    <h2>Contacto</h2>
    <p>¡Contáctame aquí!</p>
